			...
			<div class="offset-3 col-6">
				<div class="card">
					<div class="card-header">
						<a href="{{ url('umkmcategories') }}" type="button" class="btn btn-secondary"><i class="fa fa-arrow-left"> </i> Kembali</a>
					...
					<div class="card-body"> 
						...
						<form action="{{ route('umkmcategories.update',$umkm_categories->id) }}" method="post">
							...
							<div class="form-group">
								...
								<textarea type="text" class="form-control" name="description" placeholder="type something">{{ $umkm_categories->description }}</textarea>
							</div> 
